"""
Django settings for live_technology project.
...
SECRET_KEY = 'django-insecure-4hs*e=5k6k_!ot^4_-r_td#r)ggc*7wn=_j51*d-grob0j(i9k'
...
WSGI_APPLICATION = 'live_technology.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'Static')]  # Ruta a tu carpeta de archivos estáticos
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Ruta donde se almacenarán los archivos de medios subidos por el usuario
